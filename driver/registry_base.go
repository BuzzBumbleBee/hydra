...
func (m *RegistryBase) oAuth2Config() *compose.Config {
	return &compose.Config{
		...
		DeviceAndUserCodeLifespan:            m.C.GetDeviceAndUserCodeLifespan(),
		...
		DeviceVerificationURL:                m.C.DeviceInternalURL().String(),
		DeviceAuthTokenPollingInterval:       m.C.GetDeviceAuthTokenPollingInterval(),
