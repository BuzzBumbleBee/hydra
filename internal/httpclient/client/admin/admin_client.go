...
type ClientService interface {
	...
	AdminVerifyUserCodeRequest(params *AdminVerifyUserCodeRequestParams, opts ...ClientOption) (*AdminVerifyUserCodeRequestOK, error)
...
*/
func (a *Client) AdminVerifyUserCodeRequest(params *AdminVerifyUserCodeRequestParams, opts ...ClientOption) (*AdminVerifyUserCodeRequestOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewAdminVerifyUserCodeRequestParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "adminVerifyUserCodeRequest",
		Method:             "PUT",
		...
		Schemes:            []string{"http", "https"},
		Params:             params,
		Reader:             &AdminVerifyUserCodeRequestReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	for _, opt := range opts {
	...
	success, ok := result.(*AdminVerifyUserCodeRequestOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for adminVerifyUserCodeRequest: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
